...
\begin{table}[H]
\centering
\caption{Ethical Challenges and Resolutions --- Team Lead Perspective}
\label{tab:ethical}
...
\textbf{5. Burnout prevention --- lead duty of care.} Night of Mar 4--5: WebSocket CORS blocking all 3 frontend portals, demo 34h away. Two junior FE devs volunteered to ``stay all night''. I declined, pair-debugged until 01:40, merged fix, then \textit{forced} team offline --- Slack mute, ``see you 9:30 stand-up rested''. Result: Day 9 integration completed 40\% faster with rested engineers vs. the zombie-debugging trajectory --- ethical leadership protecting health over arbitrary heroics.

\textbf{6. License hygiene --- invisible ethics.} Discovered \texttt{sslcommerz-lts} (1.2.0) had no explicit LICENSE file in npm tarball during \texttt{THIRD\_PARTY\_NOTICES.md} audit. Escalated to BS-23 mentor; confirmed MIT via GitHub repo; documented exception with URL + commit hash in notices file --- preventing future legal ambiguity for anyone forking neoRMS. Small act, high ethical leverage --- typical ``invisible'' engineering ethics work.
