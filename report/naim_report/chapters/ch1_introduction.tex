...
\centering
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[node distance=1.1cm, every node/.style={draw,rounded corners,align=center,minimum width=2.4cm,minimum height=0.9cm,fill=blue!5}]
...
\draw[->,thick] (i) -- (t);
\draw[->,thick] (t) -- (doc);
\draw[->,thick,dashed] (doc) to[bend left=25] node[above,draw=none,fill=none]{iterative} (r);
\end{tikzpicture}%
}
