...
\item \textbf{Project Presentation Recording}: internal BS-23 demo --- 18 min --- available on request.
\end{itemize}
...
\begin{center}
\begin{tabular}{cc}
\qrcode[height=3.2cm]{https://github.com/naim1405/neoRMS-backend} &
...
\small Backend Repo & \small Daily Log --- BS-23 Excel \\
\small \url{github.com/naim1405/neoRMS-backend} &
\small \url{bit.ly/4anso9p} \\
& \footnotesize \url{brainstationo365-my.sharepoint.com/...}\\
\end{tabular}
\end{center}

\vspace{1em}
\noindent\textit{Left: neoRMS backend source --- 141 commits by author. Right: official BS-23 Daily Stand-up log --- DS RUET 2026 --- QR encodes direct SharePoint URL; short URL bit.ly/4anso9p provided for manual entry.}
